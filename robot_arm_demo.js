...
function fillScene() {
	...
	var robotSphere = new THREE.MeshPhongMaterial({color: 0xFFDEAD, specular: 0xFFDEAD, shininess: 150});
	...
	createRobotEvolve(plummet,saLength,robotSphere);
...
{
	var sphere = new THREE.Mesh(new THREE.SphereGeometry(10,10,50),material);
	sphere.position.x = 90 * Math.PI/180;
	sphere.position.y = length;
	part.add(sphere);
}
